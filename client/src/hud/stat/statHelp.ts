...
export const STAT_HELP: Record<string, string> = {
  ...
  'summoner.predators-howl': 'Your pack builds a stacking damage bonus as it fights together.',
  'summoner.swarm': 'Enemies attacked by several of your minions at once take extra damage.',
  'summoner.acid-brood': 'Your minions carry acid, stripping plating and bursting when they die.',
  'summoner.grazing-field': 'Idle minions graze, recovering health for the pack over time.',
  'summoner.trampled-path': 'Minions charge, gaining speed and stunning what they run through.',
  'summoner.vital-burst': 'A dying minion bursts, granting the pack brief immunity.',
  'summoner.stone-sentinel': 'Slower, sturdier minions that hold ground instead of chasing.',
  'summoner.rockslide-cover': 'Standing among your minions grants you cover.',
  'summoner.mountain-guardian': 'Your minions share your plating and damage reduction.',
