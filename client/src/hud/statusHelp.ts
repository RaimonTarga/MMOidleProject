...
const STATUS_HELP: Record<string, StatusHelp> = {
  ...
  'debuff-volcanic-heat': amb('Volcanic heat', 'Heat builds during combat, raising the damage you deal AND the damage you take. It fades out of combat and clears completely when you leave the biome or die.'),
