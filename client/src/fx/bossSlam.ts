...
export function fxSlam(
  ...
  // Central impact flash — a bright punch at the epicentre.
  ...
  // Two shockwave rings rolling out to the kill radius. Using a manual scale tween
  // from a unit circle so the stroke expands cleanly to `radius`.
  for (let i = 0; i < 2; i++) {
  ...
  // Debris kicked up at the epicentre and flung along the shockwave.
