...
assert.equal(model.usesSkills.passives['energy.per-hit'],20);
const profile=resolveEnergyRelicProfile(model.usesSkills.passives['energy.per-hit'],200,model.usesSkills.passives['energy.empowered-mult'],relicRatingsFromPassives(model.usesSkills.passives));
