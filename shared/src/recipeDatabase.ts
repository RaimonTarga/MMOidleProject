...
// Unlock order within every biome tier: boots (1/6) → charm (2/7) → armor (3/8) → weapon (4/9)
...
// Biome item tiers: forest/plains/mountain/swamp/cave T1→1 T2→2
//                   desert/jungle T1→2 T2→3 | tundra/volcanic T1→3 T2→4
...
export const RECIPE_DATABASE: Map<string, Recipe> = new Map<string, Recipe>([
  ...
  ['forest-boots-t1', {
    ...
    recipeGroup: 'forest', requiredBiomeLevel: 1, slot: 'mobility',
  ...
  ['flash-rapier', {
    ...
    recipeGroup: 'forest', requiredBiomeLevel: 4, slot: 'weapon',
  ...
  ['forest-boots-t2', {
    ...
    recipeGroup: 'forest', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['forest-blade-t2', {
    ...
    recipeGroup: 'forest', requiredBiomeLevel: 9, slot: 'weapon',
  ...
  ['mountain-boots-t1', {
    ...
    recipeGroup: 'mountain', requiredBiomeLevel: 1, slot: 'mobility',
  ...
  ['mountain-vest-t1', {
    ...
    recipeGroup: 'mountain', requiredBiomeLevel: 3, slot: 'armor',
  ...
  ['heavy-hammer', {
    ...
    recipeGroup: 'mountain', requiredBiomeLevel: 4, slot: 'weapon',
  ...
  ['mountain-boots-t2', {
    ...
    recipeGroup: 'mountain', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['mountain-charm-t2', {
    ...
    recipeGroup: 'mountain', requiredBiomeLevel: 7, slot: 'recovery',
  ...
  ['plains-boots-t1', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 1, slot: 'mobility',
  ...
  ['plains-vest-t1', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 3, slot: 'armor',
  ...
  ['plains-boots-t2', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['plains-charm-t2', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 7, slot: 'recovery',
  ...
  ['plains-blade-t2', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 9, slot: 'weapon',
  ...
  ['swamp-boots-t1', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 1, slot: 'mobility',
  ...
  ['swamp-vest-t1', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 3, slot: 'armor',
  ...
  ['ashbrand-blade', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 4, slot: 'weapon',
  ...
  ['swamp-boots-t2', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['swamp-charm-t2', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 7, slot: 'recovery',
  ...
  ['cave-boots-t1', {
    ...
    recipeGroup: 'cave', requiredBiomeLevel: 1, slot: 'mobility',
  ...
  ['cave-vest-t1', {
    ...
    recipeGroup: 'cave', requiredBiomeLevel: 3, slot: 'armor',
  ...
  ['chaotic-axe', {
    ...
    recipeGroup: 'cave', requiredBiomeLevel: 4, slot: 'weapon',
  ...
  ['cave-boots-t2', {
    ...
    recipeGroup: 'cave', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['cave-blade-t2', {
    ...
    cost: { red: 54, purple: 14 }, stats: { attack: 25 }, attacksPerSecond: 1.0, tier: 2,
    description: 'A cave-troll femur carved into a devastating weapon.',
  }],

  // ── Jungle (first appears T2) — green only ────────────────────────────────
  ['jungle-boots-t1', {
  ...
  ['jungle-boots-t2', {
    ...
    recipeGroup: 'jungle', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  // ── Desert (first appears T2) — yellow only ───────────────────────────────
  ['desert-boots-t1', {
  ...
  ['desert-boots-t2', {
    ...
    recipeGroup: 'desert', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['desert-charm-t2', {
    ...
    recipeGroup: 'desert', requiredBiomeLevel: 7, slot: 'recovery',
  ...
  // ── Tundra (first appears T3) — blue only ─────────────────────────────────
  ['tundra-boots-t1', {
  ...
  ['tundra-boots-t2', {
    ...
    recipeGroup: 'tundra', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['tundra-blade-t2', {
    ...
    recipeGroup: 'tundra', requiredBiomeLevel: 9, slot: 'weapon',
  ...
  // ── Volcanic (first appears T3) — red only ────────────────────────────────
  ['volcanic-boots-t1', {
  ...
  ['volcanic-boots-t2', {
    ...
    recipeGroup: 'volcanic', requiredBiomeLevel: 6, slot: 'mobility',
  ...
  ['volcanic-blade-t2', {
    ...
    recipeGroup: 'volcanic', requiredBiomeLevel: 9, slot: 'weapon',
