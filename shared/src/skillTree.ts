...
export interface StatEffects {
   ...
   * e.g. 0.20 = +20% attack speed. All unlocked nodes are summed additively, then applied
   * as: finalCooldown = weaponBaseCooldown / (1 + totalAttackSpeedPct).
   * This makes it multiplicative with weapon APS — same % benefit on fast and slow weapons.
   */
