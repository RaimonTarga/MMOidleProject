...
export const advancedBiomeMonsterEntriesA = [
  ...
  ['cursed-wolf', {
    ...
    stats: { hp: 420, attack: 55, plating: 8, damageReduction: 0, speed: 92, attackRange: 12, attackCooldown: 1400, pullRange: 280 },
  ...
  ['treant', {
    ...
    stats: { hp: 720, attack: 40, plating: 18, damageReduction: 0.05, speed: 18, attackRange: 15, attackCooldown: 3800, pullRange: 140 },
  ...
  ['elder-treant', {
    ...
    stats: { hp: 1800, attack: 102, plating: 40, damageReduction: 0.10, speed: 14, attackRange: 15, attackCooldown: 4200, pullRange: 140 },
    behavior: 'melee', attackStyle: 'impact', biome: 'forest',
  ...
  ['spectral-wolf', {
    ...
    stats: { hp: 950, attack: 138, plating: 10, damageReduction: 0.06, speed: 108, attackRange: 12, attackCooldown: 1200, pullRange: 300 },
    behavior: 'melee', attackStyle: 'slash', biome: 'forest',
  ...
  ['rune-golem', {
    ...
    stats: { hp: 640, attack: 46, plating: 20, damageReduction: 0.07, speed: 16, attackRange: 15, attackCooldown: 3600, pullRange: 145 },
  ...
  ['storm-eagle', {
    ...
    stats: { hp: 340, attack: 58, plating: 5, damageReduction: 0, speed: 112, attackRange: 12, attackCooldown: 1300, pullRange: 290 },
  ...
  ['colossal-titan', {
    ...
    stats: { hp: 2100, attack: 115, plating: 50, damageReduction: 0.12, speed: 12, attackRange: 15, attackCooldown: 4500, pullRange: 140 },
  ...
  ['thunder-condor', {
    ...
    stats: { hp: 800, attack: 152, plating: 12, damageReduction: 0, speed: 125, attackRange: 12, attackCooldown: 1100, pullRange: 310 },
    behavior: 'melee', attackStyle: 'slash', biome: 'mountain',
  ...
  ['war-mammoth', {
    ...
    stats: { hp: 680, attack: 42, plating: 14, damageReduction: 0.04, speed: 42, attackRange: 15, attackCooldown: 2600, pullRange: 220 },
  ...
  ['dire-wolf', {
    ...
    stats: { hp: 380, attack: 54, plating: 8, damageReduction: 0, speed: 98, attackRange: 12, attackCooldown: 1500, pullRange: 280 },
  ...
  ['ancient-guardian', {
    ...
    stats: { hp: 1700, attack: 118, plating: 42, damageReduction: 0.09, speed: 36, attackRange: 15, attackCooldown: 3000, pullRange: 200 },
    behavior: 'melee', attackStyle: 'impact', biome: 'plains',
  ...
  ['stampede-king', {
    ...
    stats: { hp: 1100, attack: 145, plating: 22, damageReduction: 0.04, speed: 82, attackRange: 12, attackCooldown: 1700, pullRange: 260 },
    behavior: 'melee', attackStyle: 'impact', biome: 'plains',
  ...
  ['bog-horror', {
    ...
    stats: { hp: 600, attack: 44, plating: 15, damageReduction: 0.05, speed: 24, attackRange: 15, attackCooldown: 2800, pullRange: 170 },
  ...
  ['plague-witch', {
    ...
    stats: { hp: 290, attack: 66, plating: 4, damageReduction: 0, speed: 56, attackRange: 12, attackCooldown: 2000, pullRange: 210 },
  ...
  ['hydra-elder', {
    ...
    stats: { hp: 1900, attack: 108, plating: 38, damageReduction: 0.09, speed: 26, attackRange: 15, attackCooldown: 2900, pullRange: 180 },
  ...
  ['shadow-toad', {
    ...
    stats: { hp: 900, attack: 142, plating: 16, damageReduction: 0.06, speed: 72, attackRange: 12, attackCooldown: 1900, pullRange: 230 },
    behavior: 'melee', attackStyle: 'poison', biome: 'swamp',
  ...
  ['cave-behemoth', {
    ...
    stats: { hp: 750, attack: 42, plating: 22, damageReduction: 0.07, speed: 16, attackRange: 15, attackCooldown: 4000, pullRange: 140 },
  ...
  ['venom-queen', {
    ...
    stats: { hp: 360, attack: 60, plating: 8, damageReduction: 0, speed: 80, attackRange: 12, attackCooldown: 1800, pullRange: 240 },
  ...
  ['stone-colossus', {
    ...
    stats: { hp: 2200, attack: 98, plating: 58, damageReduction: 0.13, speed: 12, attackRange: 15, attackCooldown: 4500, pullRange: 135 },
    behavior: 'melee', attackStyle: 'impact', biome: 'cave',
  ...
  ['abyss-crawler', {
    ...
    stats: { hp: 1100, attack: 128, plating: 28, damageReduction: 0.08, speed: 58, attackRange: 12, attackCooldown: 2000, pullRange: 240 },
    behavior: 'melee', attackStyle: 'poison', biome: 'cave',
  ...
  ['feral-gorilla', {
    ...
    stats: { hp: 620, attack: 46, plating: 13, damageReduction: 0.03, speed: 64, attackRange: 12, attackCooldown: 2200, pullRange: 240 },
  ...
  ['pit-viper', {
    ...
    stats: { hp: 330, attack: 60, plating: 6, damageReduction: 0, speed: 96, attackRange: 12, attackCooldown: 1600, pullRange: 270 },
  ...
  ['ancient-titan', {
    ...
    stats: { hp: 1750, attack: 115, plating: 40, damageReduction: 0.09, speed: 50, attackRange: 15, attackCooldown: 2800, pullRange: 220 },
    behavior: 'melee', attackStyle: 'impact', biome: 'jungle',
  ...
  ['jungle-wyvern', {
    ...
    stats: { hp: 1000, attack: 140, plating: 20, damageReduction: 0.04, speed: 90, attackRange: 15, attackCooldown: 1800, pullRange: 280 },
