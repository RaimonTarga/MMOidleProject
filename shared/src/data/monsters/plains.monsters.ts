...
export const plainsMonsterEntries = [
  ...
  ['boar', {
    ...
    stats: { hp: 80, attack: 18, plating: 0, damageReduction: 0, speed: 50, attackRange: 12, attackCooldown: 1900, pullRange: 205 },
    behavior: 'melee', attackStyle: 'impact', biome: 'plains',
  ...
  ['prairie-wolf', {
    ...
    stats: { hp: 100, attack: 22, plating: 0, damageReduction: 0, speed: 92, attackRange: 12, attackCooldown: 1200, pullRange: 275 },
  ...
  ['stampede-bull', {
    ...
    stats: { hp: 150, attack: 30, plating: 0, damageReduction: 0.05, speed: 62, attackRange: 12, attackCooldown: 1700, pullRange: 235 },
    behavior: 'melee', attackStyle: 'impact', biome: 'plains',
  ...
  ['savanna-hawk', {
    ...
    stats: { hp: 90, attack: 20, plating: 0, damageReduction: 0, speed: 50, attackRange: 165, attackCooldown: 2400, pullRange: 245 },
