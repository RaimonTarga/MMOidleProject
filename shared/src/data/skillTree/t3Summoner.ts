...
export const t3SummonerEntries = [
  ...
  ['summoner-light-t3-a', {
    ...
    description: 'Your lurkers replace your slimes. Each living lurker emits a hunter\'s aura (radius 120). Allies inside any aura gain +5% attack damage per overlapping aura, capped at +30%. Stacks decay when out of every aura.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'summoner.minion-as-cave-lurker':   1,
      'summoner.predators-howl':          1,
      'summoner.howl-radius':             120,
  ...
  ['summoner-light-t3-b', {
    id: 'summoner-light-t3-b', name: 'Web of the Hunt', tier: 3,
    classId: 'summoner-root', subVariantId: 'light',
    parent: 'summoner-light', children: [],
    description: 'Your lurkers replace your slimes. Each lurker hit weaves a Web stack onto the target (cap 8, 6 s). Webbed monsters take +6% damage per stack from all sources.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'summoner.minion-as-cave-lurker':   1,
      'summoner.web-of-the-hunt':         1,
      'summoner.web-cap':                 8,
      'summoner.web-pct-per-stack':       0.06,
      'summoner.web-ms':                  6000,
    } as Record<string, number>,
  }],
  ...
  ['summoner-balanced-t3-a', {
    ...
    description: 'Your plains-slimes pulse a heal aura every 2 s, restoring 4% max HP to allies within 100px. Out of combat the heal doubles.',
    cost: 1, statEffects: {},
    mechanicEffects: {
  ...
  ['summoner-balanced-t3-b', {
    ...
    classId: 'summoner-root', subVariantId: 'balanced',
    parent: 'summoner-balanced', children: [],
    description: 'Your boars grant allies +25% movement speed within 120px. Every 10 s each boar Charges to close distance, then its next hit always stuns the target for 1.2 s.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'summoner.minion-as-boar':          1,
      'summoner.trampled-path':           1,
      'summoner.trample-aura-radius':     120,
  ...
  ['summoner-balanced-t3-c', {
    ...
    classId: 'summoner-root', subVariantId: 'balanced',
    parent: 'summoner-balanced', children: [],
    description: 'The first plains-slime to die in a fight cleanses slow and DoT from allies within 200px and grants 3 s of debuff immunity.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'summoner.minion-as-plains-slime':  1,
      'summoner.vital-burst':             1,
      'summoner.vital-burst-radius':      200,
  ...
  ['summoner-heavy-t3-a', {
    ...
    description: 'Your ridge-archers grant allies +6 plating and +4% DR within 120px. Lose both sentries and the bonus drops to zero.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      ...
      'summoner.sentinel-radius':         120,
      'summoner.sentinel-plating':        6,
      'summoner.sentinel-dr':             0.04,
    } as Record<string, number>,
  }],
  ...
  ['summoner-heavy-t3-b', {
    ...
    classId: 'summoner-root', subVariantId: 'heavy',
    parent: 'summoner-heavy', children: [],
    description: 'Your cliff-hoppers extend your damage sponge to allies within 160px — 30% of their damage redirects to a living hopper.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'summoner.minion-as-cliff-hopper':  1,
      'summoner.rockslide-cover':         1,
      'summoner.rockslide-pct':           0.30,
      'summoner.rockslide-radius':        160,
    } as Record<string, number>,
  }],
