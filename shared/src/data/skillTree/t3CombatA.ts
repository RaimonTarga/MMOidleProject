...
export const t3CombatEntriesA = [
  ...
  ['cadence-light-t3-a', {
    ...
    mechanicEffects: { 'cadence.aftershock': 1, 'cadence.aftershock-onhit-per-tier': 10, 'cadence.aftershock-attacks': 3 },
  }],
  ['cadence-light-t3-b', {
  ...
  ['cadence-light-t3-c', {
    ...
    classId: 'cadence-root', subVariantId: 'light',
    parent: 'cadence-light', children: [],
    description: 'Your finisher strikes twice. The second hit deals 70% of the finalized first-hit damage. Neither hit counts toward the next combo.',
    cost: 1, statEffects: {},
    mechanicEffects: { 'cadence.trigger-count': 2, 'cadence.extra-trigger-damage-mult': 0.70 },
  }],
  ...
  ['cadence-balanced-t3-b', {
    ...
    classId: 'cadence-root', subVariantId: 'balanced',
    parent: 'cadence-balanced', children: [],
    description: 'Each attack building toward the finisher amplifies it by 15%. After a finisher, your next 3 attacks deal 50% bonus damage.',
    cost: 1, statEffects: {},
    mechanicEffects: { 'cadence.momentum-buildup': 0.15, 'cadence.momentum-echo': 3, 'cadence.momentum-echo-bonus': 0.50 },
  }],
  ['cadence-balanced-t3-c', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'cadence.detonation': 1, 'cadence.verdict-bank-pct': 0.30 },
  }],
  ...
  ['cadence-heavy-t3-b', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'cadence.hemorrhage': 1, 'cadence.hemorrhage-mult': 1.5, 'cadence.hemorrhage-ticks': 4, 'cadence.hemorrhage-tick-ms': 1000 },
  }],
  ['cadence-heavy-t3-c', {
  ...
  ['cooldown-light-t3-a', {
    ...
    description: 'Your execution deals its normal damage and triggers a 2.5s burst of increased attack speed (~half-uptime at the 5s cooldown). The timer keeps ticking through the burst.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'cooldown.overdrive': 1,
      'cooldown.overdrive-duration-ms': 2500,
      'cooldown.overdrive-attack-speed-pct': 0.6,
    },
  }],
  ['cooldown-light-t3-b', {
    ...
    mechanicEffects: { 'cooldown.eternal-cycle': 1, 'cooldown.eternal-cycle-flat': 8, 'cooldown.eternal-charge-duration-ms': 10000 },
  }],
  ['cooldown-light-t3-c', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'cooldown.rupture': 1, 'cooldown.rupture-dr-pierce': 0.10, 'cooldown.rupture-window-ms': 2000, 'cooldown.rupture-window-plating-mult': 0.50 },
  }],
  ...
  ['cooldown-balanced-t3-a', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'cooldown.reverb': 1, 'cooldown.reverb-bonus-per-attack': 0.05 },
  }],
  ['cooldown-balanced-t3-b', {
    ...
    mechanicEffects: {
      'cooldown.battery': 1,
      'cooldown.battery-stack-interval-ms': 1000,
      'cooldown.battery-damage-per-stack': 8,
    },
  }],
  ['cooldown-balanced-t3-c', {
    ...
    classId: 'cooldown-root', subVariantId: 'balanced',
    parent: 'cooldown-balanced', children: [],
    description: 'The longer your execution cooldown runs uninterrupted, the more damage you deal, ramping over 7 seconds to +50% regular-attack damage and +75% execution damage. Triggering early yields a proportionally smaller payoff.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'cooldown.patience-paid': 1,
      'cooldown.patience-ramp-ms': 7000,
      'cooldown.patience-attack-max': 0.50,
      'cooldown.patience-execution-max': 0.75,
    },
  }],
  ...
  ['cooldown-heavy-t3-c', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'cooldown.channeled-beam': 1, 'cooldown.channeled-beam-mult': 1.0, 'cooldown.beam-duration-ms': 3000, 'cooldown.beam-tick-ms': 500 },
  }],
  ...
  ['reload-light-t3-a', {
    ...
    description: 'The last bullet of every clip fires as an empowered shot (5.0×) with a splash — and like all empowered attacks, it scales with empowered-damage gear and passives.',
    cost: 1, statEffects: {},
    mechanicEffects: { 'reload.exploding-clip': 1, 'reload.empowered-mult': 5.0, 'reload.max-ammo': +1 },
  }],
  ['reload-light-t3-b', {
    ...
    mechanicEffects: {
      ...
      'reload.momentum-decay-interval-ms': 4000,
      'reload.momentum-reload-reduction-floor': 0.30,
    },
  }],
  ['reload-light-t3-c', {
    ...
    mechanicEffects: {
      ...
      'reload.snipe-fullhp-threshold': 0.95,
      'shared.applies-through-evade': 1,  // sniper ignores evade 
    },
  }],
  ...
  ['reload-balanced-t3-a', {
    ...
    description: 'Each attack applies a Death Mark stack to the target (up to 10). Reloading detonates all stacks on the current target for attack × stacks × 0.50 bonus damage.',
    cost: 1, statEffects: {},
    mechanicEffects: { 'reload.death-mark': 1, 'reload.death-mark-detonate-mult': 0.50, 'reload.death-mark-max': 10 },
  }],
  ['reload-balanced-t3-b', {
    ...
    mechanicEffects: {
      ...
      'reload.blunderbuss-damage-mult': -0.60,
      ...
      'reload.blunderbuss-self-knockback-dist': 110,
    },
  }],
  ['reload-balanced-t3-c', {
    ...
    mechanicEffects: { 'reload.alternating-cadence': 1, 'reload.alternating-onhit-per-tier': 30, 'reload.alternating-attack-mult': 2, 'reload.alternating-onhit-mult': 2 },
  }],
  ...
  ['reload-heavy-t3-a', {
    ...
    description: 'Replaces your magazine with a continuous laser. It fires continuously while a target is in range, building Heat from 0% to 100%. At 100% Heat it overheats and cannot fire again until fully cooled. Flat on-hit damage above 30 contributes at 60%, before core bonuses.',
    cost: 1, statEffects: {},
    mechanicEffects: {
      'reload.laser': 1,
      'reload.laser-damage-per-tick-pct': 0.16,
  ...
  ['reload-heavy-t3-c', {
    ...
    cost: 1, statEffects: {},
    mechanicEffects: { 'reload.cannon': 1, 'reload.cannon-damage-per-shot': 0.45, 'reload.cannon-charge-fraction': 0.5 },
  }],
