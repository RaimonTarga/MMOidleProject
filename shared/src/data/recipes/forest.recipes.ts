...
export const forestRecipeEntries = [
  ...
  ['forest-charm-t1', {
    ...
    upgrades: [
      { stats: { hpRegen: 2 }, cost: { green: 15 }, requiredBiomeLevel: 3 },
  ...
  ['forest-vest-t1', {
    ...
    upgrades: [
      { stats: { maxHp: 5, plating: 1, evasion: 0.05 }, cost: { green: 30 }, requiredBiomeLevel: 4 },
      { stats: { maxHp: 5, plating: 1, evasion: 0.05 }, cost: { green: 60 }, requiredBiomeLevel: 4 },
      { stats: { maxHp: 5, plating: 1, evasion: 0.05 }, cost: { green: 120 }, requiredBiomeLevel: 4 },
    ],
  }],
  ...
  ['gale-needle', {
    ...
    cost: { green: 60 }, stats: { attack: 16 }, attacksPerSecond: 1.60, tier: 2,
  ...
  ['forest-charm-t2', {
    ...
    upgrades: [
      { stats: { hpRegen: 3 }, cost: { green: 30 }, requiredBiomeLevel: 7 },
  ...
  ['forest-vest-t2', {
    ...
    upgrades: [
      { stats: { maxHp: 12, plating: 1, evasion: 0.06 }, cost: { green: 45, yellow: 15 }, requiredBiomeLevel: 8 },
      { stats: { maxHp: 12, plating: 1, evasion: 0.06 }, cost: { green: 90, yellow: 30 }, requiredBiomeLevel: 8 },
      { stats: { maxHp: 12, plating: 1, evasion: 0.06 }, cost: { green: 180, yellow: 60 }, requiredBiomeLevel: 8 },
    ],
  }],
