...
export const jungleRecipeEntries = [
  ...
  ['jungle-charm-t2', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 18 }, requiredBiomeLevel: 3 },
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 38 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 68 }, requiredBiomeLevel: 4 },
    ],
  }],
  ...
  ['jungle-boots-t2', {
    ...
    upgrades: [
      { stats: { speed: 5 }, cost: { green: 10 }, requiredBiomeLevel: 4 },
      { stats: { speed: 7 }, cost: { green: 20 }, requiredBiomeLevel: 4 },
  ...
  ['jungle-vest-t2', {
    ...
    upgrades: [
      ...
      { stats: { maxHp: 12, plating: 2, evasion: 0.04 }, cost: { green: 48 }, requiredBiomeLevel: 4 },
      { stats: { maxHp: 12, plating: 2, evasion: 0.04 }, cost: { green: 85 }, requiredBiomeLevel: 4 },
    ],
  }],
  ...
  ['jungle-venomthorn-rapier', {
    ...
    cost: { green: 116 }, stats: { attack: 24, onHitDamage: 18 }, attacksPerSecond: 1.65, tier: 3,
    icon: 'items/weapons/rapier-3.png',
    description: 'Thin and quick, and slick with a thorn-sap that bites a little more with every touch.',
    upgrades: [
      { stats: { attack: 6, onHitDamage: 4 }, cost: { green: 58 },  requiredBiomeLevel: 6 },
      { stats: { attack: 6, onHitDamage: 4 }, cost: { green: 116 }, requiredBiomeLevel: 7 },
      { stats: { attack: 6, onHitDamage: 4 }, cost: { green: 196 }, requiredBiomeLevel: 8 },
    ],
  }],
  ...
  ['jungle-charm-t3', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 50 },  requiredBiomeLevel: 7 },
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 100 }, requiredBiomeLevel: 8 },
      { mechanicEffects: { 'defense.ramp-regen-max-pct': 0.02 }, cost: { green: 175 }, requiredBiomeLevel: 8 },
    ],
  }],
  ...
  ['jungle-boots-t3', {
    ...
    upgrades: [
      { stats: { speed: 6 },  cost: { green: 28 }, requiredBiomeLevel: 8 },
      { stats: { speed: 8 },  cost: { green: 58 }, requiredBiomeLevel: 8 },
  ...
  ['jungle-vest-t3', {
    ...
    upgrades: [
      { stats: { maxHp: 18, plating: 3, evasion: 0.05 }, cost: { green: 58 },  requiredBiomeLevel: 8 },
      { stats: { maxHp: 18, plating: 3, evasion: 0.05 }, cost: { green: 116 }, requiredBiomeLevel: 8 },
      { stats: { maxHp: 18, plating: 3, evasion: 0.05 }, cost: { green: 196 }, requiredBiomeLevel: 8 },
    ],
  }],
