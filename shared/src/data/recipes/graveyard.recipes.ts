...
export const graveyardRecipeEntries = [
  ...
  ['graveyard-charm-t4', {
    ...
    cost: { purple: 150 }, stats: { recovery: 16 },
    ...
    upgrades: [
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.03 }, cost: { purple: 100 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.03 }, cost: { purple: 200 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.03 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.03 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.03 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
    ],
  }],
  ...
  ['graveyard-charm-t4-gravetide', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.01, 'defense.recovery-active-pct': 0.01 }, cost: { purple: 100 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.01, 'defense.recovery-active-pct': 0.01 }, cost: { purple: 200 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.01, 'defense.recovery-active-pct': 0.01 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.01, 'defense.recovery-active-pct': 0.01 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
      { mechanicEffects: { 'defense.recovery-pulse-pct': 0.01, 'defense.recovery-active-pct': 0.01 }, cost: { purple: 330 }, requiredBiomeLevel: 4 },
    ],
  }],
