...
export const caveRecipeEntries = [
  ...
  ['ruinous-axe', {
    ...
    cost: { red: 60 }, catalystCost: { swarming: 2 }, stats: { attack: 40 }, attacksPerSecond: 1.20, tier: 2, // family-tag: chaotic-axe (counted disruption) → Swarming
  ...
  ['cave-vest-t2', {
    ...
    cost: { red: 54 }, catalystCost: { swarming: 2 }, stats: { maxHp: 46, plating: 5, damageReduction: 0.12 }, tier: 2, // family-tag: premium %DR generalist wall → Swarming
  ...
  ['cave-boots-t2', {
    ...
    cost: { red: 33 }, catalystCost: { swarming: 2 }, stats: { speed: 39 }, tier: 2, // family-tag: cave generalist mobility → Swarming
  ...
  ['cave-cataclysm-axe', {
    ...
    cost: { red: 120 }, catalystCost: { swarming: 3 }, stats: { attack: 82 }, attacksPerSecond: 1.20, tier: 3, // family-tag: chaotic-axe → Swarming
  ...
  ['cave-vest-t3', {
    ...
    cost: { red: 116, yellow: 29 }, catalystCost: { swarming: 3 }, stats: { maxHp: 65, plating: 14, damageReduction: 0.20 }, // family-tag: premium %DR wall → Swarming
    tier: 3,
  ...
  ['cave-boots-t3', {
    ...
    cost: { red: 100 }, catalystCost: { swarming: 3 }, stats: { speed: 52 }, tier: 3, // family-tag: cave generalist mobility → Swarming
