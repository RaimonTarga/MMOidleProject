...
export const caveRecipeEntries = [
  ...
  ['ruinous-axe', {
    ...
    cost: { red: 60 }, catalystCost: { swarming: 2 }, stats: { attack: 43 }, attacksPerSecond: 1.20, tier: 2, // family-tag: chaotic-axe (counted disruption) → Swarming
    ...
    upgrades: [
      { stats: { attack: 4 }, cost: { red: 78 }, requiredBiomeLevel: 8 },
      { stats: { attack: 4 }, cost: { red: 162 }, requiredBiomeLevel: 9 },
      { stats: { attack: 5 }, cost: { red: 288 }, requiredBiomeLevel: 10 },
      { stats: { attack: 4 }, cost: { red: 288 }, requiredBiomeLevel: 10 },
      { stats: { attack: 5 }, cost: { red: 288 }, requiredBiomeLevel: 10 },
    ],
  }],
  ...
  ['cave-vest-t2', {
    ...
    cost: { red: 54 }, catalystCost: { swarming: 2 }, stats: { maxHp: 50, plating: 7, damageReduction: 0.13 }, tier: 2, // family-tag: premium %DR generalist wall → Swarming
    icon: 'items/armor/dire-bestial-hide.png',
    description: 'From a beast the deep-cavern folk name only in low voices.',
    upgrades: [
      { stats: { maxHp: 5, plating: 1, damageReduction: 0.01 }, cost: { red: 80 }, requiredBiomeLevel: 9 },
      { stats: { maxHp: 5, plating: 1, damageReduction: 0.01 }, cost: { red: 175 }, requiredBiomeLevel: 10 },
      { stats: { maxHp: 5, plating: 1, damageReduction: 0.01 }, cost: { red: 300 }, requiredBiomeLevel: 10 },
      { stats: { maxHp: 5, plating: 1, damageReduction: 0.01 }, cost: { red: 300 }, requiredBiomeLevel: 10 },
      { stats: { maxHp: 6 }, cost: { red: 300 }, requiredBiomeLevel: 10 },
    ],
  }],

  // CHARM — Absorb, deepened.
  ['cave-charm-t2', {
    id: 'cave-charm-t2', name: 'Resonant Gem',
    recipeGroup: 'cave', requiredBiomeLevel: 9, slot: 'recovery',
    cost: { red: 44 }, catalystCost: { swarming: 2 }, stats: { recovery: 4 }, // family-tag: reliable generalist recovery → Swarming
    ...
    upgrades: [
      { mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 33 }, requiredBiomeLevel: 10 },
      { stats: { recovery: 1 }, mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 66 }, requiredBiomeLevel: 10 },
      { mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 120 }, requiredBiomeLevel: 10 },
      { stats: { recovery: 1 }, mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 120 }, requiredBiomeLevel: 10 },
      { mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 120 }, requiredBiomeLevel: 10 },
    ],
  }],
  ...
  ['cave-boots-t2', {
    ...
    cost: { red: 33 }, catalystCost: { swarming: 2 }, stats: { speed: 36 }, tier: 2, // family-tag: cave generalist mobility → Swarming
    ...
    upgrades: [
      { stats: { speed: 2 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 22 }, requiredBiomeLevel: 10 },
      { stats: { speed: 2 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 44 }, requiredBiomeLevel: 10 },
  ...
  ['cave-cataclysm-axe', {
    ...
    cost: { red: 120 }, catalystCost: { swarming: 3 }, stats: { attack: 78 }, attacksPerSecond: 1.20, tier: 3, // family-tag: chaotic-axe → Swarming
    ...
    upgrades: [
      { stats: { attack: 8 }, cost: { red: 174 },  requiredBiomeLevel: 14 },
      { stats: { attack: 8 }, cost: { red: 348 }, requiredBiomeLevel: 15 },
      { stats: { attack: 8 }, cost: { red: 588 }, requiredBiomeLevel: 16 },
      { stats: { attack: 7 }, cost: { red: 588 }, requiredBiomeLevel: 16 },
      { stats: { attack: 8 }, cost: { red: 588 }, requiredBiomeLevel: 16 },
    ],
  }],
  ...
  ['cave-vest-t3', {
    ...
    cost: { red: 116, yellow: 29 }, catalystCost: { swarming: 3 }, stats: { maxHp: 91, plating: 13, damageReduction: 0.19 }, // family-tag: premium %DR wall → Swarming
    tier: 3,
    ...
    upgrades: [
      { stats: { maxHp: 9, plating: 1, damageReduction: 0.01 }, cost: { red: 135, yellow: 45 },  requiredBiomeLevel: 15 },
      { stats: { maxHp: 9, plating: 1, damageReduction: 0.01 }, cost: { red: 270, yellow: 90 }, requiredBiomeLevel: 16 },
      { stats: { maxHp: 9, plating: 1, damageReduction: 0.01 }, cost: { red: 450, yellow: 150 }, requiredBiomeLevel: 16 },
      { stats: { maxHp: 9, plating: 2, damageReduction: 0.01 }, cost: { red: 450, yellow: 150 }, requiredBiomeLevel: 16 },
      { stats: { maxHp: 9, plating: 1 }, cost: { red: 450, yellow: 150 }, requiredBiomeLevel: 16 },
    ],
  }],
  ...
  ['cave-charm-t3', {
    ...
    cost: { red: 100, green: 25 }, catalystCost: { swarming: 3 }, stats: { recovery: 7 }, // family-tag: reliable generalist recovery → Swarming
    ...
    upgrades: [
      { mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 50, green: 25 },  requiredBiomeLevel: 16 },
      { stats: { recovery: 1 }, mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 112, green: 38}, requiredBiomeLevel: 16 },
      { mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 200, green: 50 }, requiredBiomeLevel: 16 },
      { stats: { recovery: 1 }, mechanicEffects: { 'defense.absorb-pct': 0.01 }, cost: { red: 200, green: 50 }, requiredBiomeLevel: 16 },
      { stats: { recovery: 1 }, cost: { red: 200, green: 50 }, requiredBiomeLevel: 16 },
    ],
  }],
  ...
  ['cave-boots-t3', {
    ...
    cost: { red: 100 }, catalystCost: { swarming: 3 }, stats: { speed: 65 }, tier: 3, // family-tag: cave generalist mobility → Swarming
    ...
    upgrades: [
      { stats: { speed: 4 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 30 },  requiredBiomeLevel: 16 },
      { stats: { speed: 3 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 60 },  requiredBiomeLevel: 16 },
      { stats: { speed: 4 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 105 }, requiredBiomeLevel: 16 },
      { stats: { speed: 3 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 105 }, requiredBiomeLevel: 16 },
      { stats: { speed: 4 }, mechanicEffects: { 'mobility.stealth-pct': 0.02 }, cost: { red: 105 }, requiredBiomeLevel: 16 },
    ],
  }],
