...
export const volcanicRecipeEntries = [
  ...
  ['volcanic-cinderlash', {
    ...
    cost: { red: 120 }, stats: { attack: 38 }, attacksPerSecond: 1.45, tier: 3,
  ...
  ['volcanic-vest-t3', {
    ...
    upgrades: [
      ...
      { stats: { maxHp: 20, plating: 5 }, cost: { red: 120 }, requiredBiomeLevel: 5 },
      { stats: { maxHp: 20, plating: 5 }, cost: { red: 200 }, requiredBiomeLevel: 6 },
    ],
  }],
  ...
  ['volcanic-charm-t3', {
    ...
    upgrades: [
      ...
      { mechanicEffects: { 'defense.in-combat-regen-pct': 0.02, 'defense.kill-burst-pct': 0.02 }, cost: { red: 175 }, requiredBiomeLevel: 5 },
    ],
  }],
