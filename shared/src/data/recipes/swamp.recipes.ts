...
export const swampRecipeEntries = [
  ...
  ['swamp-blightbrand', {
    ...
    upgrades: [
      { stats: { attack: 8 }, cost: { purple: 58 },  requiredBiomeLevel: 10 },
      { stats: { attack: 8 }, cost: { purple: 116 }, requiredBiomeLevel: 11 },
      { stats: { attack: 8 }, cost: { purple: 196 }, requiredBiomeLevel: 12 },
    ],
  }],
  ...
  ['swamp-rimebrand', {
    ...
    upgrades: [
      { stats: { attack: 12 }, cost: { purple: 58 },  requiredBiomeLevel: 10 },
      { stats: { attack: 12 }, cost: { purple: 116 }, requiredBiomeLevel: 11 },
      { stats: { attack: 12 }, cost: { purple: 196 }, requiredBiomeLevel: 12 },
    ],
  }],
  ...
  ['swamp-charm-t3', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.absorb-pct': 0.03 }, cost: { purple: 50 },  requiredBiomeLevel: 11 },
      { mechanicEffects: { 'defense.absorb-pct': 0.03 }, cost: { purple: 100 }, requiredBiomeLevel: 12 },
