...
export const swampRecipeEntries = [
  ...
  ['swamp-vest-t2', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 6, slot: 'armor',
    ...
    upgrades: [
      { stats: { maxHp: 12, plating: 2 }, cost: { purple: 75 }, requiredBiomeLevel: 7 },
      { stats: { maxHp: 12, plating: 2 }, cost: { purple: 150 }, requiredBiomeLevel: 8 },
      { stats: { maxHp: 12, plating: 2 }, cost: { purple: 300 }, requiredBiomeLevel: 8 },
    ],
  }],
  ...
  ['swamp-charm-t2', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.absorb-pct': 0.02 }, cost: { purple: 30 }, requiredBiomeLevel: 8 },
  ...
  ['swamp-boots-t2', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 8, slot: 'mobility',
  ...
  ['swamp-vest-t3', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 10, slot: 'armor',
    ...
    upgrades: [
      { stats: { maxHp: 18, plating: 3 }, cost: { purple: 180 },  requiredBiomeLevel: 11 },
      { stats: { maxHp: 18, plating: 3 }, cost: { purple: 360 }, requiredBiomeLevel: 12 },
      { stats: { maxHp: 18, plating: 3 }, cost: { purple: 720 }, requiredBiomeLevel: 12 },
    ],
  }],
  ...
  ['swamp-charm-t3', {
    ...
    recipeGroup: 'swamp', requiredBiomeLevel: 11, slot: 'recovery',
    ...
    upgrades: [
      { mechanicEffects: { 'defense.absorb-pct': 0.04 }, cost: { purple: 75 },  requiredBiomeLevel: 12 },
      { mechanicEffects: { 'defense.absorb-pct': 0.04 }, cost: { purple: 150 }, requiredBiomeLevel: 12 },
      { mechanicEffects: { 'defense.absorb-pct': 0.04 }, cost: { purple: 300 }, requiredBiomeLevel: 12 },
    ],
  }],

  ['swamp-boots-t3', {
    id: 'swamp-boots-t3', name: 'Mire Striders',
    recipeGroup: 'swamp', requiredBiomeLevel: 12, slot: 'mobility',
