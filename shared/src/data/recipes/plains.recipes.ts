...
export const plainsRecipeEntries = [
  ...
  ['plains-vest-t2', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 6, slot: 'armor',
    ...
    upgrades: [
      { stats: { maxHp: 6, plating: 4 }, cost: { yellow: 60 }, requiredBiomeLevel: 7 },
      { stats: { maxHp: 6, plating: 4 }, cost: { yellow: 120 }, requiredBiomeLevel: 8 },
      { stats: { maxHp: 6, plating: 4 }, cost: { yellow: 240 }, requiredBiomeLevel: 8 },
    ],
  }],
  ...
  ['plains-charm-t2', {
    ...
    upgrades: [
      { mechanicEffects: { 'defense.kill-burst-pct': 0.01 }, cost: { yellow: 30 }, requiredBiomeLevel: 8 },
  ...
  ['plains-boots-t2', {
    ...
    recipeGroup: 'plains', requiredBiomeLevel: 8, slot: 'mobility',
