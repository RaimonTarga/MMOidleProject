...
export function composeMonsterView(
  ...
  return {
    ...
    speed: entity.hasPosition.speed * (entity.hasStatus?.monsterMoveSpeedMult ?? 1),
    ...
    attackCooldown: entity.performsAttack.attackCooldown * (entity.hasStatus?.monsterAttackCooldownMult ?? 1),
