...
export const ROUTES = new Map<string, Route>(
  [
    ...
    CAMPAIGN_NIGHT_KIT, ...CAMPAIGN_NIGHT_BOSSES, CAMPAIGN_NIGHT_SWAMP_DUAL_GUARD, CAMPAIGN_CAVE_DUAL_GUARD, ...CAMPAIGN_CAVE_RECOVERY_ROUTES, ...CAMPAIGN_T2_BOSS_ROUTES, ...CAMPAIGN_T2_EXPANSION_ROUTES, ...CAMPAIGN_T2_V1K_ROUTES, ...CAMPAIGN_NIGHT2_ROUTES,
