...
import { laserOnHitDamage } from '../shared/src/systems/onHitDamage';
 ...
 * `rampSeconds`, then a logarithmic tail beyond +100%. Sampled at second
  ...
  if (archetype === 'cadence') {
    ...
    if ((p['reload.laser'] ?? 0) > 0) {
      ...
      directPerHit = directNoOnHit(
        ...
        targetWithDebuffs,
        platingMult,
      ) + laserOnHitDamage(stats.dealsDamage.onHitDamage);
