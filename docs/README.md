...
| [briefs/SPIRIT_BOSS_BALANCE_HANDOFF_2026-08-30.md](briefs/SPIRIT_BOSS_BALANCE_HANDOFF_2026-08-30.md) | **Open implementation handoff.** Spirit T1 playtest evidence and the scoped boss changes: a 2-second Plains `Rallying Cry` before reinforcements, a modest T1 Greatbear HP reduction, and +3 seconds to Swamp poison duration across the T1–T3 lineage, including the T3 morph override. Barrier regeneration and broader class changes are explicitly out of scope. |
