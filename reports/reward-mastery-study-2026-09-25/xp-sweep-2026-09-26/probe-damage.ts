...
try {
  ...
  const blockers:Record<string,number>={};const dmgBy:Record<string,number>={};const wl:Record<string,number>={};const wlHits:any[]=[];const recentHits:any[]=[];
