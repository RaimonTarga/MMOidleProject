# MMO Idle T4 Subclass Mechanics Packet
...
| Conduit | balanced | Grazing Field | summoner-balanced-t3-a | Your plains-slimes pulse a heal aura every 2 s at their attack range (100px), restoring 4% max HP to allies inside. Out of combat the heal doubles. | - | summoner.grazing-field=1.00, summoner.grazing-interval-ms=2000, summoner.grazing-ooc-mult=2.00, summoner.grazing-pct=0.04, summoner.minion-as-plains-slime=1.00, summoner.minion-range=100 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 3 minions at 1.00 APS each | - |
| Conduit | balanced | Trampled Path | summoner-balanced-t3-b | Your boars grant allies +25% movement speed within their attack range (120px). Every 10 s each boar Charges to close distance, then its next hit always stuns the target for 1.2 s. | - | summoner.minion-as-boar=1.00, summoner.minion-range=120, summoner.trample-charge-cd-ms=10000, summoner.trample-charge-speed-mult=3.50, summoner.trample-speed-pct=0.25, summoner.trample-stun-ms=1200, summoner.trampled-path=1.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 3 minions at 1.00 APS each | - |
| Conduit | balanced | Vital Burst | summoner-balanced-t3-c | The first plains-slime to die in a fight cleanses slow and DoT from allies within its attack range (200px) and grants 3 s of debuff immunity. | - | summoner.minion-as-plains-slime=1.00, summoner.minion-range=200, summoner.vital-burst=1.00, summoner.vital-burst-immunity-ms=3000 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 3 minions at 1.00 APS each | - |
| Conduit | heavy | Mountain Guardian | summoner-heavy-t3-c | You summon one colossal Crag Behemoth. It taunts monsters within leash range, inherits 20% of your plating and DR, and respawns in 12 s if it falls. | - | summoner.guardian-dr-share-pct=0.20, summoner.guardian-plating-share-pct=0.20, summoner.minion-as-crag-behemoth=1.00, summoner.minion-count-cap=1.00, summoner.minion-hp-pct=1.00, summoner.minion-respawn-ms=12000, summoner.minion-size-mult=2.50, summoner.minion-speed-mult=2.00, summoner.mountain-guardian=1.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 1 minions at 1.00 APS each | - |
| Conduit | heavy | Rockslide Cover | summoner-heavy-t3-b | Your cliff-hoppers extend your damage sponge to allies within their attack range (160px) — 30% of their damage redirects to a living hopper. | - | summoner.minion-as-cliff-hopper=1.00, summoner.minion-range=160, summoner.rockslide-cover=1.00, summoner.rockslide-pct=0.30 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 1 minions at 1.00 APS each | - |
| Conduit | heavy | Stone Sentinel | summoner-heavy-t3-a | Summon two stationary ridge-archer sentries (180px attack range). They never move; if you walk beyond twice your attack range they despawn and respawn at your side. Each sentry slows nearby monsters' movement and attack... | - | summoner.minion-as-ridge-archer=1.00, summoner.minion-range=180, summoner.sentinel-respawn-mult=0.50, summoner.sentinel-slow-atk-mult=1.35, summoner.sentinel-slow-speed-mult=0.65, summoner.sentinel-tether-mult=2.00, summoner.stone-sentinel=1.00, summoner.stone-sentinel-count=2.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 2 minions at 1.00 APS each | AoE treated as single-target |
| Conduit | light | Acid Brood | summoner-light-t3-c | Your lurkers replace your slimes. Each lurker decays over 12 s, then explodes for AoE damage and applies Corrosion to nearby monsters. Bites also stack Corrosion (cap 10, −2 plating per stack). | - | summoner.acid-brood=1.00, summoner.acid-cap=10.0, summoner.acid-duration-ms=8000, summoner.acid-explosion-corrosion-stacks=2.00, summoner.acid-explosion-damage-pct=0.80, summoner.acid-explosion-radius=80.0, summoner.acid-lurker-lifetime-ms=12000, summoner.acid-plating-per-stack=2.00, summoner.minion-as-cave-lurker=1.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 6 minions at 1.00 APS each | AoE treated as single-target, infinite/stack cap approximation |
| Conduit | light | Predator's Howl | summoner-light-t3-a | Your lurkers replace your slimes. Each living lurker emits a hunter's aura at its attack range (120px). Allies inside any aura gain +5% attack speed per overlapping aura, capped at +30%. Stacks decay when out of every a... | - | summoner.howl-cap=6.00, summoner.howl-pct-per-stack=0.05, summoner.minion-as-cave-lurker=1.00, summoner.minion-range=120, summoner.predators-howl=1.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 6 minions at 1.00 APS each | infinite/stack cap approximation |
| Conduit | light | Swarm | summoner-light-t3-b | Your lurkers replace your slimes. Double your summon count again — each lurker is half as large again and shares your HP pool (1/12 each at full swarm). Swarm lurkers move faster. They spread across multiple targets whe... | - | summoner.minion-as-cave-lurker=1.00, summoner.minion-count-mult=2.00, summoner.minion-size-mult=-0.25, summoner.minion-speed-mult=1.45, summoner.overwhelmed-ms=2000, summoner.overwhelmed-pct-per-attacker=0.10, summoner.swarm=1.00 | minion count * minion APS * inherited attack; minion survival/pathing omitted; 12 minions at 1.00 APS each | - |
...
| Conduit | Grazing Field | best | Earthsunder Maul | 1386 | 1 |
| Conduit | Grazing Field | worst | Deathfang Rapier | 261 | 1 |
| Conduit | Trampled Path | best | Earthsunder Maul | 1386 | 1 |
| Conduit | Trampled Path | worst | Deathfang Rapier | 261 | 1 |
| Conduit | Vital Burst | best | Earthsunder Maul | 1386 | 1 |
| Conduit | Vital Burst | worst | Deathfang Rapier | 261 | 1 |
| Conduit | Mountain Guardian | best | Earthsunder Maul | 926 | 1 |
| Conduit | Mountain Guardian | worst | Deathfang Rapier | 175 | 1 |
| Conduit | Rockslide Cover | best | Earthsunder Maul | 926 | 1 |
| Conduit | Rockslide Cover | worst | Deathfang Rapier | 175 | 1 |
| Conduit | Stone Sentinel | best | Earthsunder Maul | 1852 | 1 |
| Conduit | Stone Sentinel | worst | Deathfang Rapier | 350 | 1 |
| Conduit | Acid Brood | best | Earthsunder Maul | 1386 | 1 |
| Conduit | Acid Brood | worst | Deathfang Rapier | 258 | 1 |
| Conduit | Predator's Howl | best | Earthsunder Maul | 1386 | 1 |
| Conduit | Predator's Howl | worst | Deathfang Rapier | 258 | 1 |
| Conduit | Swarm | best | Earthsunder Maul | 6108 | 1 |
| Conduit | Swarm | worst | Deathfang Rapier | 1152 | 1 |
...
| Striker | top | Striker / Flurry / Lancer / Shockblade | Eruption Lash +3 | 433 | 387 | 45.5 | 0.00 | 0.00 | LOW | - |
| Striker | bottom | Striker / Breaker / Lancer / Berserker | Eruption Lash +3 | 337 | 224 | 113 | 0.00 | 0.00 | EXTREME_LOW | - |
| Striker | bottom | Striker / Breaker / Lancer / Juggernaut | Eruption Lash +3 | 337 | 224 | 113 | 0.00 | 0.00 | EXTREME_LOW | - |
| Striker | bottom | Striker / Skirmisher / Lancer / Justicar | Eruption Lash +3 | 351 | 292 | 58.9 | 0.00 | 0.00 | LOW | - |
| Striker | bottom | Striker / Breaker / Lancer / Hemomancer | Eruption Lash +3 | 412 | 224 | -37.3 | 226 | 0.00 | LOW | - |
| Striker | bottom | Striker / Flurry / Lancer / Shockblade | Eruption Lash +3 | 433 | 387 | 45.5 | 0.00 | 0.00 | LOW | - |
...
| Squire | top | Squire / Bulwark / Phalanx / Avenger | Warmaul +3 | 378 | 167 | 210 | 0.00 | 0.00 | LOW | incoming damage not modeled |
| Squire | top | Squire / Warrior / Phalanx / Sunderer | Abyssal Axe +3 | 376 | 253 | 22.2 | 0.00 | 101 | LOW | execute averaged |
| Squire | bottom | Squire / Knight / Phalanx / Dynamo | Abyssal Axe +3 | 326 | 210 | 31.7 | 0.00 | 84.2 | EXTREME_LOW | execute averaged |
| Squire | bottom | Squire / Knight / Phalanx / Stalwart | Abyssal Axe +3 | 326 | 210 | 31.7 | 0.00 | 84.2 | EXTREME_LOW | execute averaged |
| Squire | bottom | Squire / Knight / Phalanx / Reverb | Warmaul +3 | 350 | 213 | 137 | 0.00 | 0.00 | LOW | high uptime assumed |
| Squire | bottom | Squire / Warrior / Phalanx / Sunderer | Abyssal Axe +3 | 376 | 253 | 22.2 | 0.00 | 101 | LOW | execute averaged |
| Squire | bottom | Squire / Warrior / Phalanx / Transcendant | Abyssal Axe +3 | 376 | 253 | 22.2 | 0.00 | 101 | LOW | execute averaged |
...
| Apprentice | bottom | Apprentice / Venom vessel / Warlock / Cultist | Earthsunder Maul +3 | 364 | 172 | 0.00 | 192 | 0.00 | LOW | high uptime assumed, infinite/stack cap approximation |
| Apprentice | bottom | Apprentice / Ember mage / Warlock / Cinder Lord | Earthsunder Maul +3 | 404 | 104 | 0.00 | 300 | 0.00 | LOW | AoE treated as single-target |
| Apprentice | bottom | Apprentice / Ember mage / Warlock / Pyromancer | Earthsunder Maul +3 | 404 | 104 | 0.00 | 300 | 0.00 | LOW | infinite/stack cap approximation |
| Apprentice | bottom | Apprentice / Venom vessel / Warlock / Venomslinger | Earthsunder Maul +3 | 414 | 172 | 0.00 | 242 | 0.00 | LOW | infinite/stack cap approximation |
...
| Spirit | top | Spirit / Phantasm / Shade / Voidwalker | Eruption Lash +3 | 415 | 255 | 160 | 0.00 | 0.00 | LOW | - |
| Spirit | top | Spirit / Spark / Shade / Channeler | Abyssal Axe +3 | 406 | 269 | 30.0 | 0.00 | 108 | LOW | execute averaged |
| Spirit | bottom | Spirit / Phantasm / Shade / Invoker | Eruption Lash +3 | 371 | 255 | 116 | 0.00 | 0.00 | LOW | - |
| Spirit | bottom | Spirit / Wraith / Shade / Aetherist | Abyssal Axe +3 | 388 | 250 | 37.3 | 0.00 | 100 | LOW | execute averaged |
| Spirit | bottom | Spirit / Wraith / Shade / Equinox | Abyssal Axe +3 | 388 | 250 | 37.3 | 0.00 | 100 | LOW | execute averaged |
| Spirit | bottom | Spirit / Spark / Shade / Channeler | Abyssal Axe +3 | 406 | 269 | 30.0 | 0.00 | 108 | LOW | execute averaged |
| Spirit | bottom | Spirit / Spark / Shade / Stormdancer | Abyssal Axe +3 | 406 | 269 | 30.0 | 0.00 | 108 | LOW | execute averaged |
...
| Slinger | top | Slinger / Artillerist / Enforcer / Warmonger | Deathfang Rapier +3 | 418 | 418 | 0.00 | 0.00 | 0.00 | LOW | infinite/stack cap approximation |
| Slinger | bottom | Slinger / Scout / Enforcer / Sniper | Earthsunder Maul +3 | 336 | 300 | 0.00 | 0.00 | 36.0 | EXTREME_LOW | high uptime assumed, infinite/stack cap approximation |
| Slinger | bottom | Slinger / Scout / Enforcer / Duelist | Glacial Rimebrand +3 | 340 | 75.5 | 0.00 | 0.00 | 264 | LOW | AoE treated as single-target, infinite/stack cap approximation |
| Slinger | bottom | Slinger / Marksman / Enforcer / Dualslinger | Deathfang Rapier +3 | 349 | 349 | 0.00 | 0.00 | 0.00 | LOW | - |
| Slinger | bottom | Slinger / Scout / Enforcer / Desperado | Deathfang Rapier +3 | 394 | 394 | 0.00 | 0.00 | 0.00 | LOW | infinite/stack cap approximation |
| Slinger | bottom | Slinger / Artillerist / Enforcer / Warmonger | Deathfang Rapier +3 | 418 | 418 | 0.00 | 0.00 | 0.00 | LOW | infinite/stack cap approximation |
| Conduit | top | Conduit / Light Frame / Mid Range / Swarm | Earthsunder Maul +3 | 6108 | 0.00 | 6108 | 0.00 | 0.00 | EXTREME_HIGH | - |
| Conduit | top | Conduit / Heavy Frame / Mid Range / Stone Sentinel | Earthsunder Maul +3 | 1852 | 0.00 | 1852 | 0.00 | 0.00 | EXTREME_HIGH | AoE treated as single-target |
| Conduit | top | Conduit / Light Frame / Mid Range / Acid Brood | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | AoE treated as single-target, infinite/stack cap approximation |
| Conduit | top | Conduit / Light Frame / Mid Range / Predator's Howl | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | infinite/stack cap approximation |
| Conduit | top | Conduit / Medium Frame / Mid Range / Grazing Field | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | - |
| Conduit | bottom | Conduit / Heavy Frame / Mid Range / Mountain Guardian | Earthsunder Maul +3 | 926 | 0.00 | 926 | 0.00 | 0.00 | - | - |
| Conduit | bottom | Conduit / Heavy Frame / Mid Range / Rockslide Cover | Earthsunder Maul +3 | 926 | 0.00 | 926 | 0.00 | 0.00 | - | - |
| Conduit | bottom | Conduit / Light Frame / Mid Range / Acid Brood | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | AoE treated as single-target, infinite/stack cap approximation |
| Conduit | bottom | Conduit / Light Frame / Mid Range / Predator's Howl | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | infinite/stack cap approximation |
| Conduit | bottom | Conduit / Medium Frame / Mid Range / Grazing Field | Earthsunder Maul +3 | 1386 | 0.00 | 1386 | 0.00 | 0.00 | EXTREME_HIGH | - |
