...
The concrete per-biome palettes (measured ground hex anchors, mob color schemes,
accent uniqueness map, reserved marker colors) live in
`biome-palette-bible.md` (added 2026-07-12). Sprite-batch prompts quote that
doc's palette words; this section only states the principle.
